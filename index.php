...
<?php
  ...
  function getTextBetweenTags($string, $tagname) {
	...
	$sql = 'select idMovie, idFile, c16 , c02, c16, c19, c22, c00, c08, c14, premiered from movie WHERE c00 LIKE :keyword OR c16 LIKE :keyword order by premiered desc ';
...
<table class='tbl-qa'>
  ...
  <tbody id='table-body'>
	...
	?>
	  <tr class='table-row'>
		<td><a
    <?php echo "<a href=\"videoPlayer.php?filename=$filename\">";?>
			<img src=<?php echo $img; ?> alt="Smiley face" height="160" width="120">
		</a></td>
